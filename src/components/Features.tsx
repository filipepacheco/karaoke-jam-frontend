        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="card bg-base-200 shadow-lg">
            <div className="card-body">
              ...
              <h3 className="card-title justify-center">For Hosts</h3>
          ...
          <div className="card bg-base-200 shadow-lg">
            <div className="card-body">
              ...
              <h3 className="card-title justify-center">For Musicians</h3>
              <p className="text-center">
          ...
          <div className="card bg-base-200 shadow-lg">
            <div className="card-body">
              ...
              <h3 className="card-title justify-center">For the Audience</h3>
              <p className="text-center">
